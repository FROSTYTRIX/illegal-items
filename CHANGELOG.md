...
- **50 recipes, no creative required.** Nothing in the mod needs commands or the
  ...
  recipe, 6 iron and 3 diamonds, exactly what breaking one gives back. The hay
  respawn anchor is the vanilla anchor with hay bales in place of the crying
  obsidian.
...
- **Some favourites:** still water and lava are the bucket plus a **honey
  ...
  **black and magenta dye chequered across the grid**, made of the two colours it
  shows. The Update Block is dirt, a clock and lime dye. Cave Game blocks are the
  modern block plus a **cobweb**, for the dust of ages.
...
- **Three seconds at the minimum**, and every level past the tenth pulls it down:
  about 1.4 seconds at Efficiency 15, under a second at 20.
...
- **The Missing Texture block.** Its model points at a texture that deliberately
  doesn't exist, so what you get is the game's real black-and-magenta placeholder
